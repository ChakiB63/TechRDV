...
public class SignUpDoctorController {
    ...
    public void initialize() {
        ...
        ArrayList<String> moroccanRegions = new ArrayList<String>();
        ...
        ObservableList<String> specialties = FXCollections.observableArrayList(
        	...
        	specialite.setItems(specialties);
    ...
    void SubmitSignUp(ActionEvent event) throws IOException {
    	 ...
    	 String selectedSpecialty = specialite.getValue();
         Admin admin = new Admin();
         Doctor doctor = new Doctor(nom.getText(),prenom.getText(), selectedAdress, tel.getText(),email.getText(), password.getText(),email.getText(),selectedSpecialty);
         //CHECK IF ALL FEILDS ARE FULL
         if (nom.getText().isEmpty() || prenom.getText().isEmpty() || selectedAdress == null
        	 ...
        	 try {
        		 ...
        		 // Check if phone number is valid Moroccan phone number
        		    ...
        		    try {
        		        if (admin.isDoctorEmailExist(email.getText())) {
